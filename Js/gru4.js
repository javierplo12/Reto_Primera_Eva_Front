...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetchFuncionesPorDia(1, ".pelicula-botones-dia-1", [7, 8, 9]); // Día 1
    fetchFuncionesPorDia(2, ".pelicula-botones-dia-2", [43, 44, 45]); // Día 2
    fetchFuncionesPorDia(3, ".pelicula-botones-dia-3", [55, 56, 57]); // Día 3
});