...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetchFuncionesPorDia(1, ".pelicula-botones-dia-1", [10, 11, 12]); // Día 1
    fetchFuncionesPorDia(2, ".pelicula-botones-dia-2", [40, 41, 42]); // Día 2
    fetchFuncionesPorDia(3, ".pelicula-botones-dia-3", [73, 74, 75]); // Día 3
});