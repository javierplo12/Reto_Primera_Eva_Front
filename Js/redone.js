...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetchFuncionesPorDia(1, ".pelicula-botones-dia-1", [13, 14, 15]); // Día 1
    fetchFuncionesPorDia(2, ".pelicula-botones-dia-2", [37, 38, 39]); // Día 2
    fetchFuncionesPorDia(3, ".pelicula-botones-dia-3", [70, 71, 72]); // Día 3
});