...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetchFuncionesPorDia(1, ".pelicula-botones-dia-1", [16, 17, 18]); // Día 1
    fetchFuncionesPorDia(2, ".pelicula-botones-dia-2", [34, 35, 36]); // Día 2
    fetchFuncionesPorDia(3, ".pelicula-botones-dia-3", [58, 59, 60]); // Día 3
});
