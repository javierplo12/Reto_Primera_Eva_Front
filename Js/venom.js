...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetchFuncionesPorDia(1, ".pelicula-botones-dia-1", [25, 26, 27]); // Día 1
    fetchFuncionesPorDia(2, ".pelicula-botones-dia-2", [49, 50, 51]); // Día 2
    fetchFuncionesPorDia(3, ".pelicula-botones-dia-3", [79, 80, 81]); // Día 3
});
